        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            <div className="relative mx-auto flex h-[420px] w-full max-w-[380px] items-center justify-center overflow-visible sm:h-[480px] sm:max-w-[460px]">
              ...
              {/* IMAGE */}
              <div className="relative z-10 h-[360px] w-[270px] overflow-hidden rounded-[32px] border border-white/10 bg-white/5 shadow-2xl shadow-black/20 sm:h-[420px] sm:w-[320px] md:h-[440px] md:w-[340px]">
                <Image
                  src="/ProfileN.jpg"
                  alt="Profile"
                  fill
                  priority
                  sizes="(max-width: 640px) 270px, (max-width: 768px) 320px, 340px"
                  className="rounded-[32px] object-cover object-center scale-[0.88]"
                />
