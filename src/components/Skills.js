...
export default function Skills() {
  ...
  return (
    <section
      id="skills"
      className="pt-28 sm:pt-32 pb-28 overflow-hidden"
    >
      <div className="container-custom">
        ...
        <div className="text-center mb-20">
          <p
            className=" text-[#a3b18a]uppercasetracking-[4px]text-smfont-semibold"
          >
            MY SKILLS
          </p>

          <h2
            className=" mt-4 text-5xl md:text-6xl font-black tracking-[-2px] "
          >
            Skills &
